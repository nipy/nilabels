...
from tests.tools.decorators_tools import pfo_tmp_test, write_and_erase_temporary_folder_with_dummy_labels_descriptor
...
def test_get_rgb_image_from_segmentation_and_label_descriptor_simple():
    ...
    np.testing.assert_equal(im_segm_rgb.get_fdata(), segm_rgb_expected)
