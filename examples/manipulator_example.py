...
import labels_manager.tools.manipulations_colors.relabeller as rel
import labels_manager.tools.manipulations_shapes.splitter as sp
...
if __name__ == '__main__':
    ...
    if run_example['Assign all others a value']:
        ...
        # using the manager:
        lm.manipulate.assign_all_other_labels_the_same_value(fin_punt_seg_original,
    ...
    if run_example['Extend slice']:
        ...
        num_slices = 5
        # using the manager:
        lm.manipulate.extend_slice_new_dimension(fin_punt_original, fin_punt_new,
    ...
    if run_example['Axial symmetrisation']:
        ...
        lm.manipulate.symmetrise_axial(fin_original, fin_transformed, axis='x', plane_intercept=128,
